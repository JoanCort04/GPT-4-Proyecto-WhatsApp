...
--
-- Host: 192.168.193.133    Database: gpt4
-- ------------------------------------------------------
...
CREATE TABLE `grupos` (
  ...
  CONSTRAINT `grupos_ibfk_1` FOREIGN KEY (`creador_id`) REFERENCES `usuarisclase` (`id`)
...
INSERT INTO `grupos` VALUES (1,'Amigos del Colegio','Grupo para los amigos del colegio.','2025-01-01 09:00:00',1),(2,'Equipo de Trabajo','Grupo para coordinar el proyecto.','2025-01-02 11:30:00',2),(3,'Familia','Grupo para la familia cercana.','2025-01-03 14:45:00',3);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`joancortes`@`%`*/ /*!50003 TRIGGER after_insert_grupo
AFTER INSERT ON grupos
FOR EACH ROW
BEGIN

    INSERT INTO grupos_de_usuarios (grupo_id, usuario_id, rol)
    VALUES (NEW.id, NEW.creador_id, 'administrador');
END */;;
DELIMITER ;
...
--
-- Table structure for table `grupos_de_usuarios`
--

DROP TABLE IF EXISTS `grupos_de_usuarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `grupos_de_usuarios` (
  `grupo_id` int(11) NOT NULL,
  `usuario_id` int(11) NOT NULL,
  `rol` enum('membre','administrador') DEFAULT 'membre',
  PRIMARY KEY (`grupo_id`,`usuario_id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `grupos_de_usuarios_ibfk_1` FOREIGN KEY (`grupo_id`) REFERENCES `grupos` (`id`),
  CONSTRAINT `grupos_de_usuarios_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarisclase` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grupos_de_usuarios`
--

LOCK TABLES `grupos_de_usuarios` WRITE;
/*!40000 ALTER TABLE `grupos_de_usuarios` DISABLE KEYS */;
INSERT INTO `grupos_de_usuarios` VALUES (1,1,'administrador'),(1,2,'membre'),(2,2,'administrador'),(3,3,'administrador');
/*!40000 ALTER TABLE `grupos_de_usuarios` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mensajes_grupos` (
  ...
  CONSTRAINT `mensajes_grupos_ibfk_1` FOREIGN KEY (`emisor_id`) REFERENCES `usuarisclase` (`id`),
  CONSTRAINT `mensajes_grupos_ibfk_2` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mensajes_usuarios` (
  ...
  CONSTRAINT `mensajes_usuarios_ibfk_1` FOREIGN KEY (`emisor_id`) REFERENCES `usuarisclase` (`id`),
  CONSTRAINT `mensajes_usuarios_ibfk_2` FOREIGN KEY (`receptor_id`) REFERENCES `usuarisclase` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `usuarisclase`
--

DROP TABLE IF EXISTS `usuarisclase`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2025-01-24 19:41:39
